...
{
    resize(970, 540);
    setWindowTitle(tr("Circuits") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Circuits address"));
    ...
    aboutAction = new QAction(tr("&About Circuits"), this);
    aboutAction->setToolTip(tr("Show information about Circuits"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Circuits"));
...
static QWidget* makeToolBarSpacer()
{
    ...
    spacer->setStyleSheet(fUseBlackTheme ? "QWidget { background-image: url(:/images/circuits_text); background-position: bottom center; background-color: transparent; background-repeat: no-repeat; }" : "QWidget { background: none; }");
    return spacer;
}
...
void BitcoinGUI::createToolBars()
{
    ...
    if (fUseBlackTheme)
    {
        ...
        header->setStyleSheet("QWidget { background-image: url(:/images/header); background-position: top center; background-color: transparent; background-repeat: no-repeat; }");
...
/*
    topToolbar = addToolBar(tr("Top Toolbar"));
    topToolbar->setObjectName("topToolbar");
    addToolBar(Qt::TopToolBarArea, topToolbar);
    topToolbar->setOrientation(Qt::Horizontal);
    topToolbar->setMovable( false );
    topToolbar->setToolButtonStyle(Qt::ToolButtonTextOnly);
    topToolbar->layout()->setSpacing(20);

    QLabel *topToolbarSpacer = new QLabel(this);
    topToolbarSpacer->setPixmap(QPixmap(":/images/spacer"));
    topToolbarSpacer->setObjectName("topToolbarSpacer");
    topToolbar->addWidget(topToolbarSpacer);
*/
}
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Circuits client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Circuits client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Circuits network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Circuits address or malformed URI parameters."));
    }
