...
bool fPANEL1UNLOCKED = false;
bool fPANEL2UNLOCKED = false;
bool fPANEL3UNLOCKED = false;
...
const string strMessageMagic = "Circuits Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    int64_t nSubsidy = 0 * COIN;
        ...
        {
            nSubsidy = 2718281 * COIN; // Pre-mine ~2.7M COIN in first block
        } else {
            nSubsidy = 0;
        }
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
	...
	// Panel unlock percentage bumps.
    if (fPANEL3UNLOCKED)
        nSubsidy += (nSubsidy * 0.03);
    else if (fPANEL2UNLOCKED)
...
//        return DoS(100, error("AcceptBlock() : reject proof-of-stake before height %d", nHeight));
